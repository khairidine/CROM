#include <universal_controller/dynamic_sliding_mode_controller.h>
...
PLUGINLIB_EXPORT_CLASS(universal_controller::DynamicSlidingModeController, controller_interface::ControllerBase)
