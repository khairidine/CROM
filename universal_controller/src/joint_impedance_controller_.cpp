#include <universal_controller/joint_impedance_controller.h>
...
PLUGINLIB_EXPORT_CLASS(universal_controller::JointImpedanceController, controller_interface::ControllerBase)
